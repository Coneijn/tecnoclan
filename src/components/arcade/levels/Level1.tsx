...
export default function Level1() {
  ...
  useEffect(() => {
    const showTimer = setTimeout(() => {
      setTutorialMsg(
        ...
        'El LED tiene polaridad: el ánodo (+) debe ir hacia el positivo de la batería. Haz clic sobre el LED para girarlo.'
      );
    }, 300);
  ...
  const handleLedClick = () => {
    ...
    // Reiniciamos la simulación para que el usuario vuelva a probar
    setIsSimulating(false);
    setSimulationState('idle');
    setFeedbackMsg('');
  };
  ...
  const handlePlay = () => {
    ...
    setTimeout(() => {
      ...
      if (boardLed.polarity === 'reversed') {
        setSimulationState('idle'); // no explota, solo no funciona
        setFeedbackMsg(
      ...
      setFeedbackMsg(
        '✅ ¡Excelente! La resistencia protege el LED y la polaridad es correcta. El circuito funciona perfectamente.'
      );
    }, 1500);
  };
    ...
    <div className="flex flex-col h-full w-full max-w-4xl mx-auto relative">
      ...
      <div className="w-full mb-2 mt-1 text-center">
        <h2 className="text-lg md:text-xl font-bold text-white/90 tracking-tight">
          🔄 Nivel 1 – Polaridad del LED
        </h2>
        <p className="text-xs text-neutral-500 mt-1">
          Coloca los componentes y asegúrate de que el LED esté en la orientación correcta.
          Haz clic sobre el LED para girarlo.
        </p>
      </div>
                ...
                {boardLed && (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Icono de girar (siempre visible) */}
